...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 150, itemHeight: 32, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _457, mouseleave: _45a, mouseover: _45e, mouseout: _461, click: _463 }, position: function (_497, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    function _4a1(_4a2, _4a3, data) {
        ...
        $(_4a3).tooltip({
            content: $("<div></div>"), position: opts.floatMenuPosition, valign: "top", data: data, onUpdate: function (_4a4) {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 30, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_50c) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.radiobutton.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_532) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkbox.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_558) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.radiogroup.defaults = {
        dir: "h", name: null, value: null, labelWidth: "", labelPosition: "after", labelAlign: "left", itemStyle: { height: 30 }, onChange: function (_568) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkgroup.defaults = {
        dir: "h", name: null, value: [], labelWidth: "", labelPosition: "after", labelAlign: "left", itemStyle: { height: 30 }, onChange: function (_57c) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, interval: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, deltaY: 0, novalidate: false, editable: true, disabled: false, readonly: false, validateOnCreate: true, validateOnBlur: false, events: {
            focus: _584, blur: _588, mouseenter: _58b, mouseleave: _58e, click: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function _5c2(_5de) {
        ...
        _5df.validatebox($.extend({}, opts, {
            deltaX: function (_5e0) {
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: {
            focus: _62b, blur: _62f, keydown: function (e) {
...
(function ($) {
    ...
    function load(_69b, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _69c, dataType: "json", success: function (data) {
                    _69d(data);
                }, error: function () {
...
(function ($) {
    function _707(_708) {
        ...
        $(_708).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _70a, doSize: false, onResize: function (_70c, _70d) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
...
(function ($) {
    ...
    function _795(_796) {
        ...
        _798.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_799, _79a) {
        ...
        if (opts.pagination) {
            ...
            _79e.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_79f, _7a0) {
    ...
    function _7af(_7b0) {
        ...
        _7b5.each(function () {
            $(this).resizable({
                handles: _7b6, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _7b1.resizing = true;
    ...
    var _8f8 = $.extend({}, _8ea(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_8f9, _8fa) {
    ...
    var _941 = {
        render: function (_942, _943, _944) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", resizeEdge: 5, autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 31, headerEvents: { mouseover: _7b9(true), mouseout: _7b9(false), click: _7bd, dblclick: _7c2, contextmenu: _7c5 }, rowEvents: { mouseover: _7c7(true), mouseout: _7c7(false), click: _7ce, dblclick: _7d8, contextmenu: _7dc }, rowStyler: function (_988, _989) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _98a, dataType: "json", success: function (data) {
                    _98b(data);
                }, error: function () {
            ...
            getTr: function (_98d, _98e, type, _98f) {
                type = type || "body";
                _98f = _98f || 0;
...
(function ($) {
    ...
    function _9c4(_9c5) {
        ...
        $(_9c5).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_9c7, row) {
    ...
    var _9d3 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9d4, _9d5, _9d6) {
            var _9d7 = [];
    ...
    $.extend(_9d3, {
        refreshGroupTitle: function (_a09, _a0a) {
...
(function ($) {
    function _a2a(_a2b) {
        ...
        if (opts.pagination) {
            ...
            _a37.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_a38, _a39) {
    ...
    var _ad0 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_ad1, _ad2, _ad3) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _ad0, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _a45(true), mouseout: _a45(false), click: _a47 }), loader: function (_b0e, _b0f, _b10) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _b0e, dataType: "json", success: function (data) {
                    _b0f(data);
                }, error: function () {
            ...
            getTr: function (_b12, id, type, _b13) {
                type = type || "body";
                _b13 = _b13 || 0;
...
(function ($) {
    function _b1c(_b1d) {
        ...
        $(_b1d).datagrid($.extend({}, opts, {
            cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[{ field: "_ck", checkbox: true }]] : undefined), columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_b1e, row, _b1f) {
                    return opts.textFormatter ? opts.textFormatter(_b1e, row, _b1f) : _b1e;
                }
            }]]
        }));
    };
    var _b20 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_b21, _b22, _b23) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _b20, textFormatter: function (_b3c, row) {
            return _b3c;
...
(function ($) {
    ...
    function _b3f(_b40) {
        ...
        $(_b40).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _b46, onChange: function () {
            }
        }));
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _b51, keydown: _b55, paste: _b55, drop: _b55, blur: _b58 }, panelEvents: {
...
(function ($) {
    ...
    var _bdb = 0;
    var _bdc = {
        render: function (_bdd, _bde, data) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_be2) {
            return _be2;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _bdc, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
            ...
            mouseover: _bc0, mouseout: _bc1, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _bc2, scroll: _bc5
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _be6, dataType: "json", success: function (data) {
                    _be7(data);
                }, error: function () {
...
(function ($) {
    function _c21(_c22) {
        ...
        var grid = _c23.grid;
        $(_c22).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
...
(function ($) {
    function _c66(_c67) {
        ...
        $(_c67).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
        ...
        _c68.grid.treegrid($.extend({}, opts, {
...
(function ($) {
    function _c92(_c93) {
        ...
        $(_c93).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_c95, _c96) {
                _c97();
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_cc4) {
...
(function ($) {
    function _ccb(_ccc) {
        ...
        $(_ccc).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _cce(this);
                _ccf(this);
                _cd0(this);
        ...
        if (!_ccd.calendar) {
            ...
            $.extend(_ccd.calendar.calendar("options"), {
...
(function ($) {
    function _cf6(_cf7) {
        ...
        $(_cf7).datebox("calendar").calendar({
            onSelect: function (date) {
...
(function ($) {
    function _d19(_d1a) {
        ...
        $(_d1a).addClass("timepicker-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _d1c(this);
                _d1d(_d1a);
...
(function ($) {
    ...
    function _d65(_d66) {
        ...
        _d68.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_d8e) {
            return _d8e;
        }, converter: {
            toPosition: function (_d8f, size) {
                var opts = $(this).slider("options");
